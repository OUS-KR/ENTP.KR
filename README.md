...
- `ENTP.KR/u/{사용자 아이디}` 주소 기반의 사용자 등록
  - 사용자 예제: [ENTP.KR/u/entp](https://entp.kr/u/entp) ([ENTP.KR/@entp](https://entp.kr/@entp))
...
- `ENTP.KR/u/{사용자 아이디}/{단축 경로}` 형태의 단축주소 생성
  - 사용자 단축주소 예제: [ENTP.KR/u/entp/links/entp-kr](https://entp.kr/u/entp/links/entp-kr) ([ENTP.KR/@entp/links/entp-kr](https://entp.kr/@entp/links/entp-kr))
...
- `ENTP.KR/u/{사용자 아이디}/{글 경로}` 형태의 글 작성
  - 사용자 글 예제: [ENTP.KR/u/entp/articles/example](https://entp.kr/u/entp/articles/example) ([ENTP.KR/@entp/articles/example](https://entp.kr/@entp/articles/example))
